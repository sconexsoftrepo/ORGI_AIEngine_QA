...
#         all_mapped_cids = {str(v) for v in activation_mappings.values()}
#         for cid in all_mapped_cids:
#             if cid not in ollama_output:
#                 ollama_output[cid] = "N"
#                 logger.info(f"No detection for class {cid} → inserting 'N'")
